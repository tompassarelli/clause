# Compiler Terms candidate vectors

This corpus freezes the process-first compiler Terms contract described by
clause:docs/compiler-terms.md. It is candidate semantic evidence, not an
...
JSON object and table order is deliberately nonsemantic. Arrays are
nonsemantic collections unless their record schema declares a semantic
sequence with explicit contiguous ordinals. Repeated premise and support
occurrences are never set-normalized. The canonical-source-order Clause pair
