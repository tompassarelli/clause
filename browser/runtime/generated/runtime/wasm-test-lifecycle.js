...
export function settleRetiredWasmSession(module, maximumCalls = 4096) {
    ...
    for (let calls = 1; calls <= maximumCalls; ++calls) {
        if (!module.clause_session_v1_reclaim_retired())
            return calls;
    }
    throw new Error("retirement exceeded driver bound");
}
//# sourceMappingURL=wasm-test-lifecycle.js.map