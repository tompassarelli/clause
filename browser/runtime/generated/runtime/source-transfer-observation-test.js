...
import { beginSourceTransferObservation as begin, finishSourceTransferObservation as finish, enterSourceTransferPhase as enter, leaveSourceTransferPhase as leave, observeSourceTransferPhase as observe, } from "./source-transfer-observation.js";
...
test("outer transfer observation is opt-in and preserves returns, throws and nested exclusive accounting", () => {
    ...
    const report = finish();
    if (!report)
        throw new Error("missing outer observation");
...
test("outer phase nesting is bounded and unfinished observations cannot be reset", () => {
    ...
    const report = finish();
    if (!report)
        throw new Error("unsettled outer observation");
...
//# sourceMappingURL=source-transfer-observation-test.js.map