...
function fixedtick_milliseconds(r) {
...
function workbenchsequencelimits_maxReceiptSequence(r) {
    return r.maxReceiptSequence;
}
function workbenchsequencelimits_maxInputSequence(r) {
    return r.maxInputSequence;
}
function workbenchsequencelimits_maxGeneration(r) {
    return r.maxGeneration;
}
function workbenchsequencelimits_maxOperationId(r) {
    return r.maxOperationId;
}
function workbenchsequencelimits_maxConfigurationRevision(r) {
...
function workbenchpolicy_maxPendingObservations(r) {
    return r.maxPendingObservations;
}
function workbenchpolicy_maxSessionIdentities(r) {
    return r.maxSessionIdentities;
}
function workbenchpolicy_maxImmutableObjects(r) {
    return r.maxImmutableObjects;
}
function workbenchpolicy_maxImmutableProperties(r) {
    return r.maxImmutableProperties;
}
function workbenchpolicy_maxEnvelopeSourceUnits(r) {
    return r.maxEnvelopeSourceUnits;
}
function workbenchpolicy_sequenceLimits(r) {
    return r.sequenceLimits;
}
function InputObservation(sequence, value) {
    return Object.freeze({ _tag: "InputObservation", sequence, value });
}
function inputobservation_sequence(r) {
    return r.sequence;
}
function inputobservation_value(r) {
    return r.value;
}
function InputConfiguration(revision, observations) {
    return Object.freeze({ _tag: "InputConfiguration", revision, observations });
}
function inputconfiguration_revision(r) {
    return r.revision;
}
function inputconfiguration_observations(r) {
...
function lifecyclereceipt_schema(r) {
    return r.schema;
}
function lifecyclereceipt_sequence(r) {
    return r.sequence;
}
function lifecyclereceipt_event(r) {
    return r.event;
}
function lifecyclereceipt_phase(r) {
    return r.phase;
}
function lifecyclereceipt_activeGeneration(r) {
    return r.activeGeneration;
}
function lifecyclereceipt_operationGeneration(r) {
    return r.operationGeneration;
}
function lifecyclereceipt_operationId(r) {
    return r.operationId;
}
function lifecyclereceipt_configurationRevision(r) {
    return r.configurationRevision;
}
function lifecyclereceipt_revision(r) {
    return r.revision;
}
function lifecyclereceipt_detail(r) {
    return r.detail;
}
...
function workbenchsnapshot_phase(r) {
    return r.phase;
}
function workbenchsnapshot_generation(r) {
    return r.generation;
}
function workbenchsnapshot_operationId(r) {
    return r.operationId;
}
function workbenchsnapshot_configurationRevision(r) {
    return r.configurationRevision;
}
function workbenchsnapshot_pendingObservations(r) {
    return r.pendingObservations;
}
function workbenchsnapshot_revision(r) {
    return r.revision;
}
function workbenchsnapshot_frame(r) {
    return r.frame;
}
function workbenchsnapshot_disposed(r) {
    return r.disposed;
}
// PackageCheck = PackageAccepted | PackageRejected
function PackageAccepted(acceptedPackage) {
    return Object.freeze({
        _tag: "PackageAccepted",
        acceptedPackage: acceptedPackage,
    });
}
function packageaccepted_acceptedPackage(r) {
    return r.acceptedPackage;
}
function PackageRejected(reason) {
    return Object.freeze({ _tag: "PackageRejected", reason: reason });
}
function packagerejected_reason(r) {
    return r.reason;
}
// SessionCompletion = SessionStarted | SessionFailed
function SessionStarted(session, revision, frame) {
    return Object.freeze({
        _tag: "SessionStarted",
        session: session,
        revision: revision,
...
function sessionstarted_session(r) {
    return r.session;
}
function sessionstarted_revision(r) {
    return r.revision;
}
function sessionstarted_frame(r) {
    return r.frame;
}
function SessionFailed(reason) {
    return Object.freeze({ _tag: "SessionFailed", reason: reason });
}
function sessionfailed_reason(r) {
    return r.reason;
}
// CandidateCompletion = CandidateProduced | CandidateFailed
function CandidateProduced(candidate) {
    return Object.freeze({ _tag: "CandidateProduced", candidate: candidate });
}
function candidateproduced_candidate(r) {
    return r.candidate;
}
function CandidateFailed(reason) {
    return Object.freeze({ _tag: "CandidateFailed", reason: reason });
}
function candidatefailed_reason(r) {
    return r.reason;
}
// AdmissionCompletion = AdmissionAccepted | AdmissionRejected
function AdmissionAccepted(successor, revision, frame) {
    return Object.freeze({
...
function admissionaccepted_successor(r) {
    return r.successor;
}
function admissionaccepted_revision(r) {
    return r.revision;
}
function admissionaccepted_frame(r) {
    return r.frame;
}
function AdmissionRejected(reason) {
    return Object.freeze({ _tag: "AdmissionRejected", reason: reason });
}
function admissionrejected_reason(r) {
    return r.reason;
}
...
function cartridgeport_acceptPackage(r) {
    return r.acceptPackage;
}
function cartridgeport_startSession(r) {
    return r.startSession;
}
function cartridgeport_runCandidate(r) {
    return r.runCandidate;
}
function cartridgeport_requestAdmission(r) {
    return r.requestAdmission;
}
function cartridgeport_disposeSession(r) {
...
function activeruntime_generation(r) {
    return r.generation;
}
function activeruntime_session(r) {
    return r.session;
}
function activeruntime_revision(r) {
    return r.revision;
}
function activeruntime_frame(r) {
    return r.frame;
}
...
function workbenchstate_phase(r) {
    return r.phase;
}
function workbenchstate_active(r) {
    return r.active;
}
function workbenchstate_operationId(r) {
    return r.operationId;
}
function workbenchstate_configuration(r) {
    return r.configuration;
}
function workbenchstate_latestReload(r) {
    return r.latestReload;
}
function workbenchstate_disposed(r) {
    return r.disposed;
}
...
function observeinput_value(r) {
    return r.value;
}
function InputRejected() {
    return Object.freeze({ _tag: "InputRejected" });
}
function FixedTickElapsed() {
    return Object.freeze({ _tag: "FixedTickElapsed" });
}
function CandidateCompleted(generation, operationId, completion) {
    return Object.freeze({
...
function candidatecompleted_generation(r) {
    return r.generation;
}
function candidatecompleted_operationId(r) {
    return r.operationId;
}
function candidatecompleted_completion(r) {
    return r.completion;
}
function CandidateBoundaryFailed(generation, operationId) {
    return Object.freeze({
...
function candidateboundaryfailed_generation(r) {
    return r.generation;
}
function candidateboundaryfailed_operationId(r) {
    return r.operationId;
}
function AdmissionCompleted(generation, operationId, completion) {
    return Object.freeze({
...
function admissioncompleted_generation(r) {
    return r.generation;
}
function admissioncompleted_operationId(r) {
    return r.operationId;
}
function admissioncompleted_completion(r) {
    return r.completion;
}
function AdmissionBoundaryFailed(generation, operationId) {
    return Object.freeze({
...
function admissionboundaryfailed_generation(r) {
    return r.generation;
}
function admissionboundaryfailed_operationId(r) {
    return r.operationId;
}
function ReloadRequested(packageCandidate) {
    return Object.freeze({
        _tag: "ReloadRequested",
        packageCandidate: packageCandidate,
    });
}
function reloadrequested_packageCandidate(r) {
    return r.packageCandidate;
}
function PackageCompleted(generation, completion) {
    return Object.freeze({
...
function packagecompleted_generation(r) {
    return r.generation;
}
function packagecompleted_completion(r) {
    return r.completion;
}
function PackageBoundaryFailed(generation) {
    return Object.freeze({
        _tag: "PackageBoundaryFailed",
        generation: generation,
    });
}
function packageboundaryfailed_generation(r) {
    return r.generation;
}
function ReloadRejected() {
    return Object.freeze({ _tag: "ReloadRejected" });
}
function SessionCompleted(generation, priorSession, completion) {
    return Object.freeze({
...
function sessioncompleted_generation(r) {
    return r.generation;
}
function sessioncompleted_priorSession(r) {
    return r.priorSession;
}
function sessioncompleted_completion(r) {
    return r.completion;
}
function SessionBoundaryFailed(generation, priorSession) {
    return Object.freeze({
...
function sessionboundaryfailed_generation(r) {
    return r.generation;
}
function sessionboundaryfailed_priorSession(r) {
    return r.priorSession;
}
function DisposeRequested() {
...
function envelopemeasure_objectCount(r) {
    return r.objectCount;
}
function envelopemeasure_propertyCount(r) {
    return r.propertyCount;
}
function envelopemeasure_sourceUnitCount(r) {
    return r.sourceUnitCount;
}
function EnvelopeCopy(source, target) {
    return Object.freeze({ _tag: "EnvelopeCopy", source, target });
}
function envelopecopy_source(r) {
    return r.source;
}
function envelopecopy_target(r) {
    return r.target;
}
// EnvelopeScan = EnvelopeScanAccepted | EnvelopeScanRejected
function EnvelopeScanAccepted(pending, targets, objectCount, propertyCount) {
    return Object.freeze({
...
function envelopescanaccepted_pending(r) {
    return r.pending;
}
function envelopescanaccepted_targets(r) {
    return r.targets;
}
function envelopescanaccepted_objectCount(r) {
    return r.objectCount;
}
function envelopescanaccepted_propertyCount(r) {
    return r.propertyCount;
}
function EnvelopeScanRejected() {
...
function require_workbench_policy(policy) {
    ...
    return positive_safe_limit_p(policy.maxPendingObservations) &&
        ...
        ? policy
        : (() => {
            throw new Error("workbench policy limits must be positive safe integers");
        })();
}
...
function scan_envelope_copy(policy, copy, copies, pending, targets, object_count, property_count) {
    ...
    for (let index = 0; index < target.length; index += 1) {
        ...
        if (Array.isArray(child)) {
            ...
            next_pending = appendValue(next_pending, EnvelopeCopy(child, child_target));
    ...
    return EnvelopeScanAccepted(next_pending, next_targets, next_object_count, next_property_count);
}
function create_workbench_envelope(incomingPolicy, sourceText) {
    ...
    let pending = [EnvelopeCopy(source, root)];
    let targets = [root];
    let object_count = 1;
    ...
    while (!isEmpty(pending)) {
        ...
        if (copy === undefined)
            throw new Error("workbench envelope source exceeds its policy");
        const scan = scan_envelope_copy(policy, copy, copies, pending.slice(0, -1), targets, object_count, property_count);
...
function require_immutable_input(policy, value) {
    return immutable_envelope_p(policy, value)
        ? value
        : (() => {
            throw new Error("workbench input observations require a checked immutable envelope");
        })();
}
function create_cartridge_workbench_bang(port, fixedTick, incomingPolicy, scheduleFixedTick, renderFrame, emitReceipt, initialPackageCandidate) {
    ...
    const reload_transition_pending = {
        value: false,
        watches: {},
    };
    const dispose_transition_pending = {
        value: false,
        watches: {},
    };
    ...
    const cancel_fixed_tick = {
        value: () => null,
        watches: {},
    };
    return (() => {
        function increment_capacity_p(current, needed, maximum) {
            return needed <= maximum - current;
        }
        function normal_receipt_capacity_p(needed) {
            return (needed <=
                sequence_limits.maxReceiptSequence - receipt_sequence.value - 1);
        }
        function capacity_failure(receipts, inputs, generations, operations, configurations) {
            return !normal_receipt_capacity_p(receipts)
                ? "receipt-sequence"
                : !increment_capacity_p(input_sequence.value, inputs, sequence_limits.maxInputSequence)
                    ? "input-sequence"
                    : !increment_capacity_p(generation_sequence.value, generations, sequence_limits.maxGeneration)
                        ? "generation-sequence"
                        : !increment_capacity_p(operation_sequence.value, operations, sequence_limits.maxOperationId)
                            ? "operation-sequence"
                            : !increment_capacity_p(state.value.configuration.revision, configurations, sequence_limits.maxConfigurationRevision)
                                ? "configuration-revision"
                                : null;
        }
        function counter_exhausted_with_session_bang(domain, uninstalled_session) {
            ...
            if (!current.disposed) {
                ...
                (() => {
                    const _a = state, _v = WorkbenchState("disposed", active, 0, current.configuration, current.latestReload, true);
                    const _old = _a.value;
                    _a.value = _v;
                ...
                (() => {
                    const _a = ticks_enabled, _v = false;
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
                ...
                (() => {
                    const _a = cancel_fixed_tick, _v = () => null;
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
                ...
                const uninstalled_disposal_uncertain = uninstalled_session == null
                    ? false
                ...
                const detail = cancel_uncertain && disposal_uncertain
                ...
                (() => {
                    const _a = state, _v = WorkbenchState("disposed", null, 0, current.configuration, current.latestReload, true);
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
        ...
        function counter_exhausted_bang(domain) {
            return counter_exhausted_with_session_bang(domain, null);
        }
        function ensure_capacity_bang(receipts, inputs, generations, operations, configurations) {
            const failure = capacity_failure(receipts, inputs, generations, operations, configurations);
            if (failure == null) {
                return true;
            }
            else {
        ...
        function ensure_capacity_retiring_bang(receipts, inputs, generations, operations, configurations, uninstalled_session) {
            const failure = capacity_failure(receipts, inputs, generations, operations, configurations);
            if (failure == null) {
                return true;
            }
        ...
        function emit_lifecycle_for_bang(event, operation_generation, operation_id, detail) {
        ...
        function emit_lifecycle_bang(event, operation_generation, detail) {
            return emit_lifecycle_for_bang(event, operation_generation, state.value.operationId, detail);
        }
        function one_shot_transition_bang() {
            const completed = { value: false, watches: {} };
            return (transition) => {
                if (completed.value) {
                    return false;
                }
        ...
        function dispose_session_once_bang(session) {
            if (runtime_session_token_p(session) &&
                !((_truthy) => _truthy !== false && _truthy != null)(disposed_sessions.has(session))) {
        ...
        function restore_settled_phase_bang() {
            ...
            const active = current.active;
            return (() => {
                const _a = state, _v = WorkbenchState(settled_phase(active), active, 0, current.configuration, current.latestReload, current.disposed);
                const _old = _a.value;
                _a.value = _v;
                for (const _k in _a.watches)
                    _a.watches[_k](_k, _a, _old, _v);
        ...
        function install_authority_bang(generation, session, revision, frame, reset_configuration, uninstalled_session, accepted_event, accepted_detail) {
            ...
            if (ensure_capacity_retiring_bang(3, 0, 0, 0, configuration_increment, uninstalled_session)) {
                ...
                (() => {
                    const _a = state, _v = WorkbenchState("successor", next_active, operation_id, next_configuration, current.latestReload, false);
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
                ...
                (() => {
                    const _a = state, _v = WorkbenchState("render", next_active, operation_id, next_configuration, current.latestReload, false);
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
                ...
                (() => {
                    const _a = state, _v = WorkbenchState("ready", next_active, 0, next_configuration, current.latestReload, false);
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
                ...
                const disposal_uncertain = !(previous_session == null) && !(previous_session === session)
        ...
        function stale_completion_bang(operation_generation, operation_id, detail) {
        ...
        function apply_transition_bang(transition) {
            return (() => {
                ...
                if (_match_1._tag === "ObserveInput") {
                    ...
                    return (() => {
                        ...
                        if (!current.disposed && ensure_capacity_bang(1, 1, 0, 0, 1)) {
                            ...
                            const observations = Object.freeze(appendValue(configuration.observations, observation));
                            const next_configuration = InputConfiguration(configuration.revision + 1, observations);
                            (() => {
                                const _a = state, _v = WorkbenchState(current.phase, current.active, current.operationId, next_configuration, current.latestReload, false);
                                const _old = _a.value;
                                _a.value = _v;
                                for (const _k in _a.watches)
                                    _a.watches[_k](_k, _a, _old, _v);
                    ...
                    return (() => {
                        try {
                            ...
                            (() => {
                                const _a = input_rejection_pending, _v = false;
                                const _old = _a.value;
                                _a.value = _v;
                                for (const _k in _a.watches)
                                    _a.watches[_k](_k, _a, _old, _v);
                    ...
                    return (() => {
                        (() => {
                            const _a = tick_transition_pending, _v = false;
                            const _old = _a.value;
                            _a.value = _v;
                            for (const _k in _a.watches)
                                _a.watches[_k](_k, _a, _old, _v);
                        ...
                        if (!current.disposed &&
                            ...
                            const configuration = current.configuration;
                            (() => {
                                const _a = state, _v = WorkbenchState("candidate", active, operation_id, empty_configuration(configuration.revision + 1), current.latestReload, false);
                                const _old = _a.value;
                                _a.value = _v;
                                for (const _k in _a.watches)
                                    _a.watches[_k](_k, _a, _old, _v);
                            ...
                            : (() => {
                                ...
                                if (_match_2._tag === "CandidateFailed") {
                                    ...
                                    return ensure_capacity_bang(1, 0, 0, 0, 0)
                                        ? (() => {
                                            emit_lifecycle_bang("candidate-failed", generation, reason);
                                    ...
                                    return ensure_capacity_bang(2, 0, 0, 0, 0)
                                        ? (() => {
                                            (() => {
                                                const _a = state, _v = WorkbenchState("admission", active, operation_id, current.configuration, current.latestReload, false);
                                                const _old = _a.value;
                                                _a.value = _v;
                                                for (const _k in _a.watches)
                                                    _a.watches[_k](_k, _a, _old, _v);
                        ...
                        return current.disposed ||
                            ...
                            : (() => {
                                ...
                                if (_match_3._tag === "AdmissionRejected") {
                                    ...
                                    return ensure_capacity_bang(1, 0, 0, 0, 0)
                                        ? (() => {
                                            emit_lifecycle_bang("admission-rejected", generation, reason);
                                            return restore_settled_phase_bang();
                                        })()
                                        : null;
                                }
                                    ...
                                    return !immutable_envelope_p(policy, frame)
                                        ? ensure_capacity_bang(1, 0, 0, 0, 0)
                                            ? (() => {
                                                emit_lifecycle_bang("admission-frame-rejected", generation, "frame-not-deeply-immutable");
                                                return restore_settled_phase_bang();
                                            })()
                                            : null
                                        : install_authority_bang(generation, active.session, revision, frame, false, null, "admission-accepted", "successor");
                                }
                                else {
                                    return null;
                                }
                    ...
                    return (() => {
                        (() => {
                            const _a = reload_transition_pending, _v = false;
                            const _old = _a.value;
                            _a.value = _v;
                            for (const _k in _a.watches)
                                _a.watches[_k](_k, _a, _old, _v);
                            ...
                            : equivalent(current.phase, "session-start")
                                ...
                                : ensure_capacity_bang(1, 0, 1, 0, 0)
                                    ? (() => {
                                        ...
                                        (() => {
                                            const _a = state, _v = WorkbenchState("package-check", current.active, 0, current.configuration, generation, false);
                                            const _old = _a.value;
                                            _a.value = _v;
                                            for (const _k in _a.watches)
                                                _a.watches[_k](_k, _a, _old, _v);
                                ...
                                if (_match_4._tag === "PackageRejected") {
                                    ...
                                    return ensure_capacity_bang(1, 0, 0, 0, 0)
                                        ? (() => {
                                            ...
                                            return emit_lifecycle_bang("package-rejected", generation, reason);
                                        })()
                                        : null;
                                }
                                    ...
                                    return (() => {
                                        ...
                                        const used_identities = retired_count +
                                            active_count +
                                        ...
                                        if (used_identities >= policy.maxSessionIdentities) {
                                            ...
                                            if (ensure_capacity_bang(1, 0, 0, 0, 0)) {
                                                ...
                                                (() => {
                                                    const _a = state, _v = WorkbenchState("session-start", active, 0, current.configuration, generation, false);
                                                    const _old = _a.value;
                                                    _a.value = _v;
                                                    for (const _k in _a.watches)
                                                        _a.watches[_k](_k, _a, _old, _v);
                                                ...
                                                const callback_completed = {
                                                    value: false,
                                                    watches: {},
                                                };
                                                const boundary_reported = {
                                                    value: false,
                                                    watches: {},
                                                };
                                                const complete_session_bang = (result) => {
                                                    if (callback_completed.value) {
                                                        return false;
                                                    }
                                                    else {
                                                        (() => {
                                                            const _a = callback_completed, _v = true;
                                                            const _old = _a.value;
                                                            _a.value = _v;
                                                            for (const _k in _a.watches)
                                                                _a.watches[_k](_k, _a, _old, _v);
                                                        ...
                                                        switch (classifyError(_catch_9)) {
                                                            case 0: {
                                                                ...
                                                                if (!callback_completed.value &&
                                                                    ...
                                                                    (() => {
                                                                        const _a = boundary_reported, _v = true;
                                                                        const _old = _a.value;
                                                                        _a.value = _v;
                                                                        for (const _k in _a.watches)
                                                                            _a.watches[_k](_k, _a, _old, _v);
                    ...
                    return (() => {
                        ...
                        const current = state.value;
                        const current_completion = !current.disposed &&
                            generation === current.latestReload &&
                            equivalent(current.phase, "session-start");
                        if (!current_completion) {
                            ...
                            const disposal_uncertain = (() => {
                                ...
                                if (_match_5._tag === "SessionStarted") {
                                    ...
                                    return (() => {
                                        const active = current.active;
                                        const current_session = active == null ? null : active.session;
                            ...
                            return (() => {
                                ...
                                if (_match_6._tag === "SessionFailed") {
                                    ...
                                    return ensure_capacity_bang(1, 0, 0, 0, 0)
                                        ? (() => {
                                            restore_settled_phase_bang();
                                            return emit_lifecycle_bang("session-failed", generation, reason);
                                        })()
                                        : null;
                                }
                                    ...
                                    return (() => {
                                        ...
                                        return !runtime_session_token_p(session)
                                            ? ensure_capacity_bang(1, 0, 0, 0, 0)
                                                ? (() => {
                                                    restore_settled_phase_bang();
                                                    return emit_lifecycle_bang("session-invalid", generation, "runtime-session-reference-required");
                                                })()
                                                : null
                                            : ((_truthy) => _truthy !== false && _truthy != null)(disposed_sessions.has(session))
                                                ? ensure_capacity_bang(1, 0, 0, 0, 0)
                                                    ? (() => {
                                                        restore_settled_phase_bang();
                                                        return emit_lifecycle_bang("session-retired", generation, "retired-runtime-session-rejected");
                                                    })()
                                                    : null
                                                : !(previous_session == null) &&
                                                    ...
                                                    ? ensure_capacity_bang(1, 0, 0, 0, 0)
                                                        ? (() => {
                                                            restore_settled_phase_bang();
                                                            return emit_lifecycle_bang("session-reused", generation, "fresh-runtime-session-required");
                                                        })()
                                                        : null
                                                    : !immutable_envelope_p(policy, frame)
                                                        ? ensure_capacity_retiring_bang(1, 0, 0, 0, 0, session)
                                                            ? (() => {
                                                                const disposal_uncertain = dispose_session_once_bang(session);
                                                                restore_settled_phase_bang();
                                                                return emit_lifecycle_bang("session-frame-rejected", generation, disposal_uncertain
                                                                    ? "session-disposal-uncertain"
                                                                    : "frame-not-deeply-immutable");
                                                            })()
                                                            : null
                                                        : install_authority_bang(generation, session, revision, frame, true, session, "session-started", "fresh-runtime-session");
                                    })();
                                }
                                else {
                                    return null;
                    ...
                    return (() => {
                        (() => {
                            const _a = dispose_transition_pending, _v = false;
                            const _old = _a.value;
                            _a.value = _v;
                            for (const _k in _a.watches)
                                _a.watches[_k](_k, _a, _old, _v);
                        ...
                        if (!current.disposed && ensure_capacity_bang(1, 0, 0, 0, 0)) {
                            ...
                            const disposal_uncertain = active == null
                                ? false
        ...
        function dispatch_bang(transition) {
            transition_queue.value.push(transition);
            if (!dispatching.value) {
                (() => {
                    const _a = dispatching, _v = true;
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
                        ...
                        return (() => {
                            while (true) {
                                if (transition_queue.value.length > 0) {
                                    ...
                                    (() => {
                                        const _a = transition_queue, _v = Array.from(restValues(transition_queue.value));
                                        const _old = _a.value;
                                        _a.value = _v;
                                        for (const _k in _a.watches)
                                            _a.watches[_k](_k, _a, _old, _v);
        ...
        function observe_input_bang(value) {
            const current = state.value;
            const configuration = current.configuration;
                ...
                : retained_inputs >= policy.maxPendingObservations
                    ? (() => {
                        if (!input_rejection_pending.value) {
                            (() => {
                                const _a = input_rejection_pending, _v = true;
                                const _old = _a.value;
                                _a.value = _v;
                                for (const _k in _a.watches)
                                    _a.watches[_k](_k, _a, _old, _v);
        ...
        function reload_package_bang(package_candidate) {
            const current = state.value;
            return current.disposed
                ? false
                : reload_transition_pending.value
                    ...
                    : equivalent(current.phase, "package-check")
                        ...
                        : equivalent(current.phase, "session-start")
                            ? (() => {
                                (() => {
                                    const _a = reload_transition_pending, _v = true;
                                    const _old = _a.value;
                                    _a.value = _v;
                                    for (const _k in _a.watches)
                                        _a.watches[_k](_k, _a, _old, _v);
        ...
        function fixed_tick_elapsed_bang() {
            ...
            if (!ticks_enabled.value ||
                ...
                (() => {
                    const _a = tick_transition_pending, _v = true;
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
        ...
        function dispose_workbench_bang() {
            ...
            if (current.disposed || dispose_transition_pending.value) {
                ...
                (() => {
                    const _a = dispose_transition_pending, _v = true;
                    const _old = _a.value;
                    _a.value = _v;
                    for (const _k in _a.watches)
                        _a.watches[_k](_k, _a, _old, _v);
        ...
        function snapshot_bang() {
            ...
            const active = current.active;
            const configuration = current.configuration;
            return WorkbenchSnapshot(current.phase, active_generation(active), current.operationId, configuration.revision, configuration.observations.length, active_revision(active), active_frame(active), current.disposed);
        }
        const scheduled = (() => {
            try {
                ...
                if (equivalent(typeof cancel, "function")) {
                    (() => {
                        const _a = cancel_fixed_tick, _v = cancel;
                        const _old = _a.value;
                        _a.value = _v;
                        for (const _k in _a.watches)
                            _a.watches[_k](_k, _a, _old, _v);
                    ...
                    (() => {
                        const _a = ticks_enabled, _v = true;
                        const _old = _a.value;
                        _a.value = _v;
                        for (const _k in _a.watches)
                            _a.watches[_k](_k, _a, _old, _v);
                    ...
                    return (() => {
                        throw new Error("fixed-tick scheduler must return a cancellation function");
                    })();
                }
            }
            catch (_catch_11) {
                switch (classifyError(_catch_11)) {
                    case 0: {
                        ...
                        (() => {
                            const _a = state, _v = WorkbenchState("disposed", null, 0, empty_configuration(0), 0, true);
                            const _old = _a.value;
                            _a.value = _v;
                            for (const _k in _a.watches)
                                _a.watches[_k](_k, _a, _old, _v);
