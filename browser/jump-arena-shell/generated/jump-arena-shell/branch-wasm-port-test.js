...
test["expect"]($$bc$str(evidence.commandEvidence.length)).toBe("2");
test["expect"](json_string(branch_command.occurrence)).toBe(json_string(occurrences[0]));
test["expect"]($$bc$str(branch_command.step.length)).toBe("32");
test["expect"]($$bc$str(branch_command.observation.length)).toBe("32");
...
test["expect"](((!(json_string(authoritative_command.step) === json_string(branch_command.step))) ? "true" : "false")).toBe("true");
test["expect"](((!(json_string(authoritative_command.observation) === json_string(branch_command.observation))) ? "true" : "false")).toBe("true");
