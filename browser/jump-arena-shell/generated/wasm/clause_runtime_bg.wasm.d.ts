...
export const clause_session_v1_explain_bulk: (a: number, b: number, c: number) => [number, number, number, number];
export const clause_session_v1_intervene_bulk: (a: number, b: number, c: number, d: number) => [number, number, number, number];
